    ...
    <SafeAreaView style={{flex: 1 , backgroundColor: 'ghostwhite'}}>
      ...
      <View style={styles.container}>
        <View style={styles.container2}>
          <TextInput placeholder='email here .. ' style={styles.input} onChange={e => handleChange(e , 'email' )}  />
            <TextInput placeholder='username' style={styles.input} onChange={e => handleChange(e , 'username')} />
            <TextInput placeholder='password' style={styles.input} onChange={e => handleChange(e , 'password' )} secureTextEntry={true}  />
        </View>
